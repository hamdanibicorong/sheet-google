...
//import app.MyAplication.helper.SqliteHelper;
import ga.danytux.myapplication.helper.SqliteHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AndroidNetworking.get("https://script.google.com/macros/s/AKfycbzO8tM5hh-cdalxoP01sJZ8xwOsKmd83LBy9a4acWB2Jpmqldlc/exec/exec?action=read&tableName=presensi")
